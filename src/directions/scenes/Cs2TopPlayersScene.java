...
public final class Cs2TopPlayersScene extends Scene {
     ...
     * amber in between ("okay"). The cutoffs are read off HLTV's own
     ...
     * black, and the line colours must keep top billing. No threshold edge
     * lines: extra horizontals read as gridlines and clutter the frame, so
     * the colour change alone marks the boundary.
     */
    private static List<ValueBand> buildRatingBands() {
        ...
        for (Object[] stratum : strata) {
            ...
            Color edge = new Color(h, s, 0f, 0f);
